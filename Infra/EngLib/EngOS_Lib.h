...
EXTERN TTaskProperty* EngOS_Task_CreateProperty(const U8* pubName, void* pfnFunc(void*), TTaskRunType eRunType, U32 ulInterval);
EXTERN TTaskProperty* EngOS_Task_GetProperty(const U8* pubName);
