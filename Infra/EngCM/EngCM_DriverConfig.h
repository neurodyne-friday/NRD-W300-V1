...
{
	/*	DeviceKey				Name				HalID						*/
	{	ADC_NAME_CURRENT_PHA,	"CurrentSensor1",	HAL_ADC_NAME_CURRENT_PHA	},	
	{	ADC_NAME_CURRENT_PHB,	"CurrentSensor2",	HAL_ADC_NAME_CURRENT_PHB	},	
	//{	ADC_NAME_CURRENT_PHC,	"CurrentSensor3",	HAL_ADC_NAME_CURRENT_PHC	},	
	{	ADC_NAME_CURRENT_VBUS,	"V-Bus Measure",	HAL_ADC_NAME_VBUS			},	
	{	ADC_NAME_CURRENT_TEMP,	"TempSensor",		HAL_ADC_NAME_TEMP			},
...
EXTERN TUART s_astDeviceUARTTbl[] =
{
	...
	{	UART_NAME_MAIN,			"RS232-Debug",		HAL_UART_NAME_USART2,	UART_RX_TYPE_ISR	},	
