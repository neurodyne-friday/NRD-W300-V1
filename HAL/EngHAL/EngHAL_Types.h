...
{
	/* Output */
	HAL_GPIO_NAME_INDICATOR,	// PB2, IHM07M1
	...
	// IHM07M1 Test Board
	HAL_GPIO_NAME_L6230_CH1_EN,	// PC10
	HAL_GPIO_NAME_L6230_CH2_EN,	// PC11
	HAL_GPIO_NAME_L6230_CH3_EN,	// PC12
    
	/* Input */
	HAL_GPIO_NAME_DIAG,	// PA6, IHM07M1

	HAL_GPIO_NAME_MAX,
	HAL_GPIO_NAME_UNSPECIFIED = HAL_GPIO_NAME_MAX
} THalGPIOName;
...
typedef enum
{
	HAL_ADC_NAME_CURRENT_PHA,	// ADC IN0
	HAL_ADC_NAME_CURRENT_PHB,	// ADC IN11
	HAL_ADC_NAME_CURRENT_PHC,	// ADC IN10

	HAL_ADC_NAME_VBUS,			// ADC IN1
	HAL_ADC_NAME_TEMP,			// ADC IN12
